...
package com.tnsif.scannerconcept;
...
public class PersonDemo {
	...
	public static void main(String[] args) {
		...
		/*
		 * Person person1 = new Person(); person1.setAge(20); person1.setName("Rohith");
		 * person1.setGender("male"); person1.setIncome(32000.50f);
		 * System.out.println(person1);
		 */
		// Initializing the object through parameterized constructor
		/*
		 * Person person2 = new Person(21, "Shastry", 34500.34f, "male");
